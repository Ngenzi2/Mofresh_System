  ...
  return (
    <>
     ...
     text-start
      ...
      "
            >
              <Button className="w-auto text-green-600 bg-[#fcdf03] font-bold text-sm md:text-2xl hover:bg-amber-300 px-6 sm:px-8 md:px-12 lg:px-15 rounded-xl py-4 sm:py-5 md:py-6 lg:py-7">
                Shop Fresh Now
              </Button>
            </div>
          </div>
